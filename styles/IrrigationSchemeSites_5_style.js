var size = 0;
var placement = 'point';
function categories_IrrigationSchemeSites_5(feature, value, size, resolution, labelText,
        ...
        image: new ol.style.RegularShape({radius: 8.0 + size, points: 5,
            radius2: 4.0, displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(36,113,31,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.52}), fill: new ol.style.Fill({color: 'rgba(36,113,31,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
                    break;
case 'On-going civil works':
                    return [ new ol.style.Style({
...
var style_IrrigationSchemeSites_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("scheme-sta");
    ...
    var style = categories_IrrigationSchemeSites_5(feature, value, size, resolution, labelText,
